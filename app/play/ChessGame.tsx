...
export default function ChessGame() {
  ...
  const [timedOutColor,    setTimedOutColor]    = useState(initialTimedOut);
  const [copyPgnState,     setCopyPgnState]     = useState(initialCopyPgn);
  const [copyFenState,     setCopyFenState]     = useState(initialCopyFen);
